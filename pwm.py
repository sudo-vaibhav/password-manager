...
if len(sys.argv) != 2:
    ...
    if arguement == "new" or arguement == "edit":
        ...
        if suggestion == "y":
            ...
            suggestion = input(
                "would you like to use this as new password for {} ?[y/n]".format(key))
            if suggestion == 'y':
        ...
        key = input(
            "enter the name of service whose password has to be deleted: ")
        ...
        if passwords == {}:
            ...
            print("Stored passwords available for: ")
        ...
        if arguement in passwords.keys():
            ...
            print(
                "password for {} service not available... please try again".format(arguement))
            sys.exit()
